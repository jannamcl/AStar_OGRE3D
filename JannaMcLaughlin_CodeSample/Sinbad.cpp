...
Sinbad::Sinbad(std::string name, std::string filename, float height, float angleOffset) 
{
...
void 
Sinbad::setBaseAnimation(AnimID id, bool reset)
{
...
void 
Sinbad::updateAnimations(Ogre::Real deltaTime)
{
	using namespace Ogre;
...
void 
Sinbad::fadeAnimations(Ogre::Real deltaTime)
{
	using namespace Ogre;
...
void 
Sinbad::updateLocomote(Ogre::Real deltaTime)
{
...
void 
Sinbad::update(Ogre::Real deltaTime)
{
...
void 
Sinbad::moveTo(GridNode* node)						// Use A* to move to this node from your current spot
{
